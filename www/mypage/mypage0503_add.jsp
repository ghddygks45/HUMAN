...
<head>
	...
	<title>그룹추가 &lt; 그룹관리 &lt; 대화하기 &lt; 내정보 | 전문가정보 데이터베이스</title>
	<script>
		$(function(){
			currentPage(5,3);
		})
			...
			<div class="inner">
				...
				<div class="cont_wrap">
                    ...
                    <div class="board_wrap">
                        <div class="row">
                            <div class="div_th">그룹명</div>
                            <div class="div_td">
                                <div class="input_td">
                                    <input type="text" class="inp_w_100" title="그룹명 입력">
                                    <span class="msg_cau">추가하고자 하는 그룹명을 입력하세요.</span>
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<div class="btn_top">
						<div class="btn_wrap">
							...
							<div class="r">
								<a href="#n" class="btn sz_free bg_orange" onclick="LayerPopupOpen('addPerson');return false;">인맥추가</a>
								<a href="#n" class="btn sz_free bg_gray" onclick="LayerPopupOpen('alertMsg');return false;">인맥삭제</a>
							</div>
						</div>
					</div>
							...
							<li>
								...
								<div class="r">
									...
									<div class="list_btn_wrap">
										<a href="#n" class="btn_cancel" onclick="LayerPopupOpen('alertMsg');return false;">삭제</a>
									</div>
								</div>
							</li>
							<li>
                    ...
                    <div class="btn_wrap">
                        <div class="c">
                            <a href="mypage0503_list.jsp" class="btn bg_orange btn_write">저장하기</a>
                            <a href="mypage0503_list.jsp" class="btn bg_gray btn_write">취소하기</a>
                        </div>
					</div>
