...
<head>
	...
	<title>대화방 관리 &lt; 대화하기 &lt; 내정보 | 전문가정보 데이터베이스</title>
	<script>
		$(function(){
			currentPage(5,4);
		})
				...
				<div class="cont_wrap">
					...
					<div class="btn_top">
						<div class="btn_wrap">
							...
							<div class="r">
								<a href="mypage0504_view.jsp" class="btn sz_free bg_orange">대화방 입장</a>
								<a href="#n" class="btn sz_free bg_gray" onclick="LayerPopupOpen('alertMsg');return false;">퇴장하기</a>
							</div>
						</div>
					</div>
					...
					<div class="msg_list group_list">
						<ul class="list">
							<li>
								...
								<div class="r">
									<div class="group_tit">
										<a href="mypage0504_view.jsp">
											<span class="font_color_blue">단체 대화방</span> <span class="opening_date">개설일시 2020.09.14 13:19:37</span>
										</a>
									</div>
									<div class="pic_wrap">
										<div class="pic">
											<a href="#n" onclick="LayerPopupOpen('expert_view');return false;">
									...
									<div class="list_btn_wrap group_btn_wrap">
										<a href="#n" class="btn_exit" onclick="LayerPopupOpen('alertMsg');return false;">퇴장하기</a>
									</div>
								</div>
							</li>
							<li>
								...
								<div class="r">
									<div class="group_tit">
										<a href="mypage0504_view.jsp">
											<span class="font_color_blue">1:1 대화방</span> <span class="opening_date">개설일시 2020.09.14 13:19:37</span>
										</a>
									</div>
									<div class="pic_wrap">
										<div class="pic">
							...
							<li class="no_data">등록된 정보가 없습니다.</li>
						</ul>
					</div>
					<!-- // 리스트 -->
