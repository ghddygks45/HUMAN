...
<head>
	...
	<title>받은 메시지 &lt; 메시지 &lt; 내정보 | 전문가정보 데이터베이스</title>
	<script>
		$(function(){
			currentPage(2,1);
		})
						...
						<ul class="list">
							<li>
								...
								<div class="r">
									...
									<div class="acq">
										<h4>
											<a href="mypage0201_view.jsp" class="text_ellips">테스트용 메세지 보내기 입니다.</a>
										</h4>
										<ul class="ul_list01">
											<li>
												<span>보낸사람</span>
