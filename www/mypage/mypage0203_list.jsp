...
<head>
	...
	<title>메시지 보관함 &lt; 메시지 &lt; 내정보 | 전문가정보 데이터베이스</title>
	<script>
		$(function(){
			currentPage(2,3);
		})
		...
		<main id="content">
			<div class="inner">
				...
				<div class="cont_wrap">
					...
					<div class="search_wrap">
                        <div class="board_wrap date_form">
                            <div class="search_form">
                                <div class="input_td">
                                    <div class="ip_search">
                                        <input type="text" class="inp_default" title="메시지 입력" placeholder="메시지를 입력해주세요.">
                                        <a href="#n" class="btn_search bg_blue">검색</a>
									</div>
                                </div>                                            
								<span class="msg_cau">보관하지 않은 메시지는 1년 후 자동으로 삭제됩니다.</span>
                            </div>
						</div>
                    </div>
					<!-- // 검색 -->
					...
					<div class="msg_list send_msg_list">
						<ul class="list">
							<li>
								...
								<div class="r">
									...
									<div class="acq">
										<h4>
											<a href="mypage0201_view.jsp" class="text_ellips"><span class="font_color_blue">[받은 메시지]</span> 테스트용 메세지 보내기 입니다.</a>
										</h4>
										<ul class="ul_list01">
											<li>
												<span>보낸사람</span>
							...
							<li>
								...
								<div class="r">
									...
									<div class="acq">
										<h4>
											<a href="mypage0202_view.jsp" class="text_ellips"><span class="font_color_blue">[보낸 메시지]</span> 테스트용 메세지 보내기 입니다.</a>
										</h4>
										<ul class="ul_list01">
											<li>
												<span>받는사람</span>
										...
										<button type="button" class="btn_cancel_msg" onclick="LayerPopupOpen('cancelMsg');return false;"><span>발송취소</span></button>
									</div>
								</div>
							</li>
							<li class="no_data">
					...
					<!-- 발송취소 레이어팝업 -->
					<div class="layer-popup-box" data-popup="cancelMsg">
						<div class="popup pop_w364">
							<div class="top">
								<h3>확인</h3>
								<button type="button" onclick="LayerPopupClose('cancelMsg');"><span class="blind">닫기</span></button>
							</div>
							<div class="pop-content">
								...
								<div class="btn_wrap">
									<div class="c">
										<a href="#n" class="btn bg_orange btn_write" onclick="LayerPopupClose('cancelMsg');">확인</a>
									</div>
								</div>
