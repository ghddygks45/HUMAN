...
<head>
	...
	<title>맺은 지인 &lt; 대화하기 &lt; 내정보 | 전문가정보 데이터베이스</title>
	<script>
		$(function(){
			currentPage(5,1);
		})
				...
				<div class="cont_wrap">
					...
					<div class="btn_top">
						<div class="btn_wrap">
							...
							<div class="r">
								<a href="#n" class="btn sz_free bg_orange" onclick="LayerPopupOpen('minimumPerson');return false;">선택대화</a>
							...
							<li>
								...
								<div class="r">
									...
									<div class="list_btn_wrap">
										...
										<a href="#n" class="btn_meg" onclick="LayerPopupClose('expert_view');LayerPopupOpen('sendMsgBox');return false;">메시지</a>
										<a href="#n" class="btn_cancel">삭제</a>
									</div>
								</div>
							</li>
							<li>
								...
								<div class="r">
									...
									<div class="list_btn_wrap">
										<a href="#n" class="btn_meg" onclick="LayerPopupClose('expert_view');LayerPopupOpen('sendMsgBox');return false;">메시지</a>
										<a href="#n" class="btn_cancel">요청취소</a>
									</div>
								</div>
							</li>
					...
					<!-- 한 명 이상 레이어팝업 -->
					<div class="layer-popup-box" data-popup="minimumPerson">
						<div class="popup pop_w364">
							<div class="top">
								<h3>알림</h3>
								<button type="button" onclick="LayerPopupClose('minimumPerson');"><span class="blind">닫기</span></button>
							</div>
							<div class="pop-content">
								...
								<div class="btn_wrap">
									<div class="c">
										<a href="#n" class="btn bg_orange btn_write" onclick="LayerPopupClose('minimumPerson');">확인</a>
									</div>
								</div>
