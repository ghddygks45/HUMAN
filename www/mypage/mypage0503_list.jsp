...
<head>
	...
	<title>그룹관리 &lt; 대화하기 &lt; 내정보 | 전문가정보 데이터베이스</title>
	<script>
		$(function(){
			currentPage(5,3);
		})
		...
		<main id="content">
			<div class="inner">
				...
				<div class="cont_wrap">
					...
					<h3 class="title">그룹관리</h3>
					<!-- 검색 -->
					<div class="search_wrap">
                        <div class="board_wrap date_form sel_v1">
					...
					<div class="btn_top">
						<div class="btn_wrap">
							...
							<div class="r">
								<a href="mypage0503_add.jsp" class="btn sz_free bg_orange">그룹추가</a>
								<a href="#n" class="btn sz_free bg_gray" onclick="LayerPopupOpen('alertMsg');return false;">그룹삭제</a>
							</div>
						</div>
					</div>
					...
					<div class="msg_list group_list">
						<ul class="list">
							<li>
								...
								<div class="r">
									<div class="group_tit">
										<a href="mypage0503_add.jsp">
											<span class="font_color_blue">테스트 그룹</span> : 참여자 수 <span class="col_orange">(10명)</span>
										</a>
									</div>
									<div class="pic_wrap">
										<div class="pic">
									...
									<div class="list_btn_wrap group_btn_wrap">
										<a href="mypage0504_view.jsp" class="btn_talk">대화하기</a>
									</div>
								</div>
							</li>
							<li>
								...
								<div class="r">
									<div class="group_tit">
										<a href="mypage0503_add.jsp">
											<span class="font_color_blue">테스트 그룹</span> : 참여자 수 <span class="col_orange">(2명)</span>
										</a>
									</div>
									<div class="pic_wrap">
										<div class="pic">
