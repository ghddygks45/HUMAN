...
<head>
    ...
    <title>상세 &lt; 전문가 찾기 &lt; 전문가 보기 | 전문가정보 데이터베이스</title>
    <script>
		$(function(){
			currentPage(1);
		})
				...
				<div class="cont_wrap">
                    ...
                    <div class="exp-view-top">
                        <h2 class="title">
                            ...
                            <a href="#n" onclick="window.open('pop_expert_view.jsp','','width=700,height=800,scrollbars=yes');return false;" title="검색결과 인쇄하기">
                                <span class="blind">인쇄하기</span>
                            </a>
                        </h2>
                        <div class="list-link"><a href="expert_list.jsp">목록</a></div>
                    </div>
                            ...
                            <div class="writing">
                                ...
                                <ul>
                                    <li>
                                        <strong>단행본</strong>
                                        <ul>
                                            <li>마을기업 지역공동체 회복 정책수단, 한국학술정보, 2017</li>
                                            <li>마을기업 지역공동체 회복 정책수단, 한국학술정보, 2017</li>
                                            <li>마을기업 지역공동체 회복 정책수단, 한국학술정보, 2017</li>
                                            <li>마을기업 지역공동체 회복 정책수단, 한국학술정보, 2017</li>
                                            <li>마을기업 지역공동체 회복 정책수단, 한국학술정보, 2017</li>
